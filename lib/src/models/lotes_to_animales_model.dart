...
class LotesToAnimalesModel {
  ...
  Lotes get lotes => _lotes;
  set lotes(Lotes lotes) => _lotes = lotes;

  LotesToAnimalesModel.fromJson(Map<String, dynamic> json) {
    _animales = json['animales'] != null
        ? new Animales.fromJson(json['animales'])
        : null;
    _cantidad = json['cantidad'];
    _id = json['id'];
    _lotes = json['lotes'] != null ? new Lotes.fromJson(json['lotes']) : null;
  }
...
class Animales {
  ...
  double get pesokg => _pesokg;
  set pesokg(double pesokg) => _pesokg = pesokg;
