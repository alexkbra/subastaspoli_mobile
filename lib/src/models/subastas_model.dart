...
class SubastasModelList{
  List<SubastasModel> items = new List();
  SubastasModelList();
  SubastasModelList.fromJsonList(List<dynamic> jsonList){
    if(jsonList == null) return;
    for(var item in jsonList){
      final subasta = new SubastasModel.fromJson(item);
      items.add(subasta);
    }
  }
}
...
class SubastasModel {
  ...
  SubastasModel.fromJson(Map<String, dynamic> json) {
