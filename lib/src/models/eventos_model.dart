...
class EventosModelList{
  List<EventosModel> items = new List();
  EventosModelList();
  EventosModelList.fromJsonList(List<dynamic> jsonList){
    if(jsonList == null) return;
    for(var item in jsonList){
      final novedad = new EventosModel.fromJson(item);
      items.add(novedad);
    }
  }
...
class EventosModel {
  ...
  EventosModel(
    ...
    this._videoUrl = videoUrl == null ? "": videoUrl;
  }
  ...
  List<Subastas> get subastas => _subastas;
  set subastas(List<Subastas> subastas) => _subastas = subastas;
  String get videoUrl => _videoUrl;
  set videoUrl(String videoUrl) => _videoUrl = videoUrl;

  EventosModel.fromJson(Map<String, dynamic> json) {
    ...
    _nombre = json['nombre'];
    if (json['subastas'] != null) {
      _subastas = new List<Subastas>();
      json['subastas'].forEach((v) {
        _subastas.add(new Subastas.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this._subastas != null) {
      data['subastas'] = this._subastas.map((v) => v.toJson()).toList();
    }
...
class Subastas {
  ...
  set lotes(List<Lotes> lotes) => _lotes = lotes;
  String get nombre => _nombre;
  set nombre(String nombre) => _nombre = nombre;
  bool get pagaAnticipo => _pagaAnticipo;
  set pagaAnticipo(bool pagaAnticipo) => _pagaAnticipo = pagaAnticipo;
  int get pesobaseporkg => _pesobaseporkg;
  set pesobaseporkg(int pesobaseporkg) => _pesobaseporkg = pesobaseporkg;
  int get pesototallote => _pesototallote;
  set pesototallote(int pesototallote) => _pesototallote = pesototallote;
  int get valorAnticipo => _valorAnticipo;
  set valorAnticipo(int valorAnticipo) => _valorAnticipo = valorAnticipo;
  int get valoractual => _valoractual;
  set valoractual(int valoractual) => _valoractual = valoractual;
  int get valorinicial => _valorinicial;
  set valorinicial(int valorinicial) => _valorinicial = valorinicial;
  int get valortope => _valortope;
  set valortope(int valortope) => _valortope = valortope;
  String get videoUrl => _videoUrl;
  set videoUrl(String videoUrl) => _videoUrl = videoUrl;
  ...
  Subastas.fromJson(Map<String, dynamic> json) {
    ...
    _imagenUrlContentType = json['imagenUrlContentType'];
    if (json['lotes'] != null) {
      _lotes = new List<Lotes>();
      json['lotes'].forEach((v) {
        _lotes.add(new Lotes.fromJson(v));
      });
    }
    _nombre = json['nombre'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['imagenUrlContentType'] = this._imagenUrlContentType;
    if (this._lotes != null) {
      data['lotes'] = this._lotes.map((v) => v.toJson()).toList();
    }
    data['nombre'] = this._nombre;
...
class Lotes {
  ...
  int get pesobaseporkg => _pesobaseporkg;
  set pesobaseporkg(int pesobaseporkg) => _pesobaseporkg = pesobaseporkg;
  int get pesopromedio => _pesopromedio;
  set pesopromedio(int pesopromedio) => _pesopromedio = pesopromedio;
  int get pesototallote => _pesototallote;
  set pesototallote(int pesototallote) => _pesototallote = pesototallote;
