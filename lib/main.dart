    ...
    return Provider(
      child: MaterialApp(
        ...
        onGenerateRoute: (RouteSettings setttings) {
          print('runta llama!! ${setttings.name}');
          return MaterialPageRoute(
            builder: (BuildContext context) =>
                DefaultHomePage(title: 'Ruta no especifica'),
          );
        },
      ),
    );
...
class DefaultHomePage extends StatefulWidget {
  DefaultHomePage({Key key, this.title}) : super(key: key);
...
class _DefaultHomePageState extends State<DefaultHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: MenuBottomNavigationBarUtil(),
    );
  }
}
